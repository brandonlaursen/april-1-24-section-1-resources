...
// Baking pies
function bakingPies(pieType, pieQuantity) {
...
// console.log(bakingPies("applePie", 5));

// print pie cost
function pieCost(pieType) {
  const recipe = recipes[pieType];
...
// console.log(pieCost("applePie"));

// sell pie
function sellPie(costOfPie, pieQuantity, profitMargin) {
...
function bakeAndSellPies(pieType, pieQuantity, profitMargin) {
  ...
  bakingPies(pieType, pieQuantity);
  let costOfPie = pieCost(pieType);
